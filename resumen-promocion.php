            ...
            <div id="amigop" name="amigoPrincipalDiv">
                <div class="card mt-10">
                    <div class="card-header">
                        ...
                        ?>
                        <h2 class="text-center"> <span>Resumen</span></h2>
                            ...
                            <table class="table" name="table" id="table">
                                <thead class="table-dark" style="position: sticky;">
                                    <tr style="position: sticky;">
                                        ...
                                        <th scope="col" class="text-center">#Repetidos</th>
                                        <th scope="col" class="text-center">#Real Promovidos</th>
                                ...
                                <tbody style="overflow: auto; ">
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            if ($meta == 0) {
                                                ...
                                                $avance = ($promovidosReales / $meta) * (100);
                                            }
                                            //    $sp =  $row["sp"];
                                            //    $sp =  $row["sp"];
                                    ...
                                    ?>
                                            <tr id="row-<?php echo $count ?>">
                                                ...
                                                <td class="text-center "><?php echo $promovidos ?></td>
                                                <td class="text-center "><?php echo $repetidos ?></td>
                                        ...
                                        ///AVANCE TOTAL
                                        $avanceTotal = ($promovidosRealesTotal / $metasTotal) * (100);
                                ...
                                <tfoot class="table-primary" style="position: sticky;">
                                    <tr style="position: sticky;">
                                        ...
                                        <th scope="col" class="text-center"><?php echo $promovidosTotal ?></th>
                                        <th scope="col" class="text-center"><?php echo $repetidosTotal ?></th>
                                        <th scope="col" class="text-center"><?php echo $promovidosRealesTotal ?></th>
                                        <td class="text-center">
                                            <span><?php echo round($avanceTotal, 2)  ?></span>%
                                        </td>
                                    </tr>
                                </tfoot>
                            <?php
